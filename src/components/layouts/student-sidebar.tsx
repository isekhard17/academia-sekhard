...
const navigation = [
  { name: 'Dashboard', icon: LayoutDashboard, path: '/alumno', exact: true },
  { name: 'Resumen Académico', icon: Award, path: '/alumno/resumen' },
  { name: 'Mis Cursos', icon: BookOpen, path: '/alumno/cursos' },
  { name: 'Mis Notas', icon: GraduationCap, path: '/alumno/notas' },
  { name: 'Mi Asistencia', icon: Clock, path: '/alumno/asistencia' },
  { name: 'Mis Compañeros', icon: Users, path: '/alumno/compañeros' },
